...
public class AutorController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Autor> updateAutor(@RequestBody Autor autor, Integer id){
        return new ResponseEntity<>(service.editAutor(autor, id), HttpStatus.OK);
    }

    @GetMapping("/{id}")
    public ResponseEntity<Autor> getAutor(@RequestBody Integer id){
        return new ResponseEntity<>(service.getAutor(id), HttpStatus.OK);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Autor> deleteAutor(@RequestBody Integer id){
